...
namespace TempLat {
    ...
    public:
        ...
        RunParameters(ParameterParser& par):
                ...
                nBinsSpectra(floor(sqrt(2.0)/2.0 * N / deltaKBin)), // Number of bins in spectra //our own contribution
                ...
                Pbool(par.get<bool>("Pbool", false, Important)),
                Pconst(par.get<T>("Pconst", 0, Important))
        {
