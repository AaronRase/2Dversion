...
namespace TempLat {
    ...
    public:
        ...
        void measure(int n, R t, Model& model)
        {
            ...
            if( (n % xiOutputFreq == 0 )  ){
              xiMeasurer.measure(model,t, ximethod);
              filesManager.flush();
            }
        ...
        {
            return (n % outputFreq == 0 || n % infreqOutputFreq == 0 || n % rareOutputFreq == 0 || n % xiOutputFreq == 0); //our own contribution
        }
